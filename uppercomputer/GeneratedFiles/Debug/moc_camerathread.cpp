...
QT_MOC_LITERAL(1, 13, 9), // "gotAImage"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "Mat"
QT_MOC_LITERAL(4, 28, 9), // "originimg"
QT_MOC_LITERAL(5, 38, 10), // "featureimg"
QT_MOC_LITERAL(6, 49, 8) // "getImage"

    },
    "CameraThread\0gotAImage\0\0Mat\0originimg\0"
    "featureimg\0getImage"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gotAImage((*reinterpret_cast< Mat(*)>(_a[1])),(*reinterpret_cast< Mat(*)>(_a[2]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CameraThread::gotAImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraThread::gotAImage(Mat _t1, Mat _t2)
{
